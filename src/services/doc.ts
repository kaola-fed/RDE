...
//       readPkgJson(resolve('template/package.json'), () => {}, false, (err, data) => resolve(err ? {} : data))
//     })
//   },
//
//   getLintData() {
...
//       try {
//         const data = require(resolve('template', val))
//         return {...obj, [val]: data}
//       } catch {
//         return {...obj}
//       }
...
//           const subContent =
//           (value as any).map(i => `<a href="${this.parseNpmLink(i)}" target="_blank">${i}</a><br>`)
