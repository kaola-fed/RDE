...
rde/0.0.1-beta.1 darwin-x64 node-v10.5.0
$ rde --help [COMMAND]
USAGE
  $ rde COMMAND
...
...
_See code: [lib/commands/build.js](https://github.com/kaolafed/rde/blob/v0.0.1-beta.1/lib/commands/build.js)_
...
_See code: [lib/commands/create.js](https://github.com/kaolafed/rde/blob/v0.0.1-beta.1/lib/commands/create.js)_
...
_See code: [lib/commands/docker/run.js](https://github.com/kaolafed/rde/blob/v0.0.1-beta.1/lib/commands/docker/run.js)_
...
_See code: [lib/commands/docs/publish.js](https://github.com/kaolafed/rde/blob/v0.0.1-beta.1/lib/commands/docs/publish.js)_
...
_See code: [lib/commands/docs/serve.js](https://github.com/kaolafed/rde/blob/v0.0.1-beta.1/lib/commands/docs/serve.js)_
...
_See code: [lib/commands/install.js](https://github.com/kaolafed/rde/blob/v0.0.1-beta.1/lib/commands/install.js)_
...
_See code: [lib/commands/lint.js](https://github.com/kaolafed/rde/blob/v0.0.1-beta.1/lib/commands/lint.js)_
...
_See code: [lib/commands/publish.js](https://github.com/kaolafed/rde/blob/v0.0.1-beta.1/lib/commands/publish.js)_
...
_See code: [lib/commands/run.js](https://github.com/kaolafed/rde/blob/v0.0.1-beta.1/lib/commands/run.js)_
...
_See code: [lib/commands/serve.js](https://github.com/kaolafed/rde/blob/v0.0.1-beta.1/lib/commands/serve.js)_
...
_See code: [lib/commands/sync.js](https://github.com/kaolafed/rde/blob/v0.0.1-beta.1/lib/commands/sync.js)_
<!-- commandsstop -->
